	...
	<!--< div region="center" border="true" title="center" style="border-left:0px;border-right:0px;overflow:hidden;"> -->		
		<div class="easyui-layout" id="subWrap" fit="true" style="width:100%;height:100%;">
			<div region="north" border="true" title="查询条件" split="false" style="height:209px;" data-options="iconCls:'icon-search'">
				<form action="batchDeleteSysConfDo" id="deleteIdsForm">
					<input type="hidden" value="" name="deleteIds" id="deleteIdsInput" />
				</form>
				<form action="#" onsubmit="return submitQuery();" id="queryFormId"
					method="post" style="margin-left:20px;margin-top:11px;">
					<table cellpadding="1">
<!-- 						<tr> -->
<!-- 							<td>CFGCategory:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgCategory_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr> -->
<!-- 							<td>CFGGroup:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgGroup_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr> -->
<!-- 							<td>CFGKey:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgKey_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr> -->
<!-- 							<td>CFGKeyType:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgKeyType_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr id="advanced_0"> -->
<!-- 							<td>CFGValue:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgValue_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr id="advanced_1"> -->
<!-- 							<td>CFGValueType:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgValueType_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr id="advanced_2"> -->
<!-- 							<td>CFGValueInfo:</td> -->
<!-- 							<td><input class="easyui-textbox" name="cfgValueInfo_like" -->
<!-- 								style="width: 250px; height: 26px;"></td> -->
<!-- 						</tr> -->
<!-- 						<tr id="advanced_3"> -->
<!-- 							<td>状态:</td> -->
<!-- 							<td><select class="easyui-combobox" name="status_equ" -->
...
<!-- 						<tr id="advanced_7"> -->
<!-- 							<td>修改日期:从</td> -->
<!-- 							<td><input class="easyui-datetimebox" name="modifyTimeAfter" -->
<!-- 								style="width: 250px; height: 26px;" editable="false" -->
<!-- 								editable="false" /></td> -->
<!-- 							<td>到</td> -->
...
function submitQuery(){
	doing();
	$('#list_data').datagrid({
		url : '<%=basePath%>/sysconf/querySysConfDo.do?'+$('form').serialize()
	});
...
// 				  {field:'cfgCategory',title:'<span>CFG类别</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgGroup',title:'<span>CFG组</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgKey',title:'<span>CFG主键</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgKeyType',title:'<span>CFG主键类型</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgValue',title:'<span>CFG值</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgValueType',title:'<span>CFG值类型</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'cfgValueInfo',title:'<span>CFG信息</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'status',title:'<span>状态</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'creator',title:'<span>创建人</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'createTime',title:'<span>创建时间</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'modifier',title:'<span>修改人</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'modifyTime',title:'<span>修改时间</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'att1',title:'<span>扩展属性1</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'att2',title:'<span>扩展属性2</span>',align:'center',sortable:'true',width:100},
// 		          	{field:'att3',title:'<span>扩展属性3</span>',align:'center',sortable:'true',width:100},
		          	
		          	{field:'cfgCategory',title:'<span>类别</span>',align:'center',sortable:'true',width:150},
		          	{field:'cfgGroup',title:'<span>组</span>',align:'center',sortable:'true',width:150},
		          	{field:'cfgKey',title:'<span>key</span>',align:'',sortable:'true',width:150},
		          	{field:'cfgValue',title:'<span>值</span>',align:'',sortable:'true',width:100},
		          	{field:'cfgValueInfo',title:'<span>说明</span>',align:'',sortable:'true',width:200},
		          	{field:'creator',title:'<span>创建人</span>',align:'center',sortable:'true',width:80},
		          	{field:'createTime',title:'<span>创建时间</span>',align:'center',sortable:'true',width:150},
		          	{field:'modifier',title:'<span>修改人</span>',align:'center',sortable:'true',width:80},
		          	{field:'modifyTime',title:'<span>修改时间</span>',align:'center',sortable:'true',width:150},
...
// 						if (r) {
// 							$.ajax({
//								'url':'<%=basePath%>/sysconf/bacthDeleteSysConfDo.do',
// 								'type':'post',
// 								'data':{'uuids':uuids},
// 								'dateType':'xml',
...
// 		}
	...
	function openEdit(uuid){
		$('#editIframe').attr("src","<%=basePath%>/sysconf/fowardEditSysConf.do?uuid_equ="+ uuid);
